...
class CardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void saveData() async{
      ...
      prefs.setString('field1', nameSellerController.text);
      prefs.setString('field2', familySellerController.text);
      prefs.setString('field3', phoneSellerController.text);
    }
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  Get.find<createShopController>().removeCard(this);
                                },
                                child: Text(
                                  'لغو',
